...
def ninja(request, color=None):
	static_path = "../static/disappearninjas/images/{}.jpg" #static files don't like to load variables in django templates
	...
	return render(request, 'disappearninjas/show.html', context)
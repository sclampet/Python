...
class UserManager(models.Manager):
	...
	def create_user(self, alias, first, last, email, pw_hash):
		user = self.create(alias=alias, first_name=first, last_name=last, email=email, pw_hash=pw_hash)
		return user
	...
	def get_user_info(self, user_id):
		...
		try:
			...
			print books
			user_reviews = self.filter(id=user_id).annotate(num=Count('user_review'))
